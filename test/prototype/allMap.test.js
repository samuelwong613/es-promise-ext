...
describe('Promise.allMap', () => {
  ...
  test('should resolve with a Map of results when all promises resolve', async () => {
    ...
    const result = await Promise.resolve().allMap(inputMap);
  ...
  test('should reject when any promise is rejected', async () => {
    ...
    await expect(Promise.resolve().allMap(inputMap)).rejects.toBe('Error');
  });
  ...
  test('should throw TypeError if input is not a Map', () => {
    expect(() => Promise.resolve().allMap([])).toThrow(TypeError);
    expect(() => Promise.resolve().allMap({})).toThrow(TypeError);
    expect(() => Promise.resolve().allMap(null)).toThrow(TypeError);
  });
});