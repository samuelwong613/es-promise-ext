type AllMapFunction = () => Promise<Map<any, any>>
 ...
 */
export default function allMap(values: Map<any, Promise<unknown> | unknown>): AllMapFunction {
  if (!(values instanceof Map))
    throw TypeError('Promise.prototype.allMap parameter 1 must be a Map');
